import { Phone, Shield, Star, Bug, Leaf, Home, Award, Users, Clock, ChevronDown, MapPin, Mail } from 'lucide-react';
      ...
      <header className="bg-white shadow-md sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between gap-4">
          ...
          <nav className="hidden lg:flex items-center gap-6">
            <a href="/" className="text-gray-700 hover:text-cyan-500 transition-colors">Home</a>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <button onClick={() => setIsQuoteModalOpen(true)} className="bg-cyan-500 text-white px-10 py-5 rounded-xl hover:bg-cyan-600 transition-all text-lg shadow-xl hover:shadow-2xl transform hover:scale-105">Get My Free Quote</button>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
              {[{icon:Shield,label:"Selke Guarantee"},{icon:Home,label:"Pet & Family Safe"},{icon:Star,label:"Licensed & Insured"},{icon:Users,label:"Local Experts"}].map(({icon:Icon,label})=>(
                <div key={label} className="flex flex-col items-center"><div className="w-12 h-12 bg-cyan-500/20 rounded-full flex items-center justify-center mb-2"><Icon className="w-6 h-6 text-cyan-400" /></div><span className="text-sm text-gray-300">{label}</span></div>
              ))}
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {city.topPests.map((pest, i) => (
              <div key={i} className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
                <div className="w-14 h-14 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-full flex items-center justify-center mb-5"><Bug className="w-7 h-7 text-white" /></div>
            ...
            {[
              ...
              <div key={title} className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
                ...
                <ul className="space-y-2 text-gray-600">
                  {["EPA-approved products","Pet & family safe","Selke Guarantee included"].map(i=><li key={i} className="flex items-start gap-2"><span className="text-cyan-500 mt-1">✓</span><span>{i}</span></li>)}
                </ul>
              </div>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { season: "Spring", tip: "Ant & termite swarm season. Begin mosquito treatments as temperatures rise above 50°F." },
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button onClick={() => setIsQuoteModalOpen(true)} className="bg-cyan-800 text-white px-10 py-5 rounded-xl hover:bg-cyan-900 transition-all text-lg border-2 border-white shadow-xl">Get My Free Quote</button>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="mt-6"><button onClick={() => setIsLegalModalOpen(true)} className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">Privacy Policy & Terms</button></div>
            </div>
          </div>
