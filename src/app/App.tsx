        ...
        <button onClick={() => setIsGuaranteeModalOpen(true)} className="absolute bottom-8 right-8 hidden md:block cursor-pointer group">
          <style>{`
            @keyframes shake {
              ...
              25% { transform: rotate(12deg) translateX(-10px); }
              75% { transform: rotate(12deg) translateX(10px); }
            }
            .animate-shake-4 { animation: shake 0.5s ease-in-out 4; }
          `}</style>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 bg-cyan-500/20 rounded-full flex items-center justify-center mb-2"><Shield className="w-6 h-6 text-cyan-400" /></div>
                <span className="text-sm text-gray-300">Selke Guarantee</span>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 bg-cyan-500/20 rounded-full flex items-center justify-center mb-2"><Home className="w-6 h-6 text-cyan-400" /></div>
                <span className="text-sm text-gray-300">Pet & Family Safe</span>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 bg-cyan-500/20 rounded-full flex items-center justify-center mb-2"><Star className="w-6 h-6 text-cyan-400" /></div>
                <span className="text-sm text-gray-300">Licensed & Insured</span>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 bg-cyan-500/20 rounded-full flex items-center justify-center mb-2"><Users className="w-6 h-6 text-cyan-400" /></div>
      ...
      <section id="services" className="py-20 bg-gray-50" aria-label="Our Services">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">Comprehensive pest control solutions tailored to protect your home and family</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-full flex items-center justify-center mb-6"><Bug className="w-8 h-8 text-white" /></div>
              <h3 className="text-2xl mb-4">General Pest Control</h3>
              <p className="text-gray-600 mb-6">Complete protection against ants, roaches, spiders, and other common household pests. Our proven treatments keep your home pest-free year-round.</p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start gap-2"><span className="text-cyan-500 mt-1">✓</span><span>Interior & exterior treatment</span></li>
                <li className="flex items-start gap-2"><span className="text-cyan-500 mt-1">✓</span><span>Quarterly maintenance plans</span></li>
                <li className="flex items-start gap-2"><span className="text-cyan-500 mt-1">✓</span><span>Safe for pets & children</span></li>
              </ul>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-full flex items-center justify-center mb-6"><Leaf className="w-8 h-8 text-white" /></div>
              <h3 className="text-2xl mb-4">Mosquito Control</h3>
              <p className="text-gray-600 mb-6">Enjoy your outdoor spaces without the annoyance of mosquitoes. Our targeted treatments reduce mosquito populations by up to 96%.</p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start gap-2"><span className="text-cyan-500 mt-1">✓</span><span>Yard & perimeter treatment</span></li>
                <li className="flex items-start gap-2"><span className="text-cyan-500 mt-1">✓</span><span>Monthly seasonal service</span></li>
                <li className="flex items-start gap-2"><span className="text-cyan-500 mt-1">✓</span><span>Event-based treatments available</span></li>
              </ul>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-full flex items-center justify-center mb-6"><Home className="w-8 h-8 text-white" /></div>
              <h3 className="text-2xl mb-4">Flea & Tick Control</h3>
              <p className="text-gray-600 mb-6">Protect your pets and family from fleas and ticks. Our comprehensive treatments eliminate existing infestations and prevent future problems.</p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start gap-2"><span className="text-cyan-500 mt-1">✓</span><span>Indoor & outdoor treatment</span></li>
                <li className="flex items-start gap-2"><span className="text-cyan-500 mt-1">✓</span><span>Pet-safe formulations</span></li>
                <li className="flex items-start gap-2"><span className="text-cyan-500 mt-1">✓</span><span>Follow-up inspections included</span></li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1"><CheckCircle className="w-4 h-4" /></div>
                    <div>
              ...
              <div className="relative">
                <img src={techWalking} alt="Selke Pest Control technician performing professional pest control service in Charlotte Metro area" className="rounded-2xl shadow-2xl" width="600" height="500" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">Simple steps to protect your home between treatments</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <div className="w-14 h-14 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-lg flex items-center justify-center mb-4"><Shield className="w-7 h-7 text-white" /></div>
              <h3 className="text-xl mb-3">Prevention</h3>
              <p className="text-gray-600 mb-2">Seal Entry Points</p>
              <p className="text-sm text-gray-500">Check windows, doors, and foundation for gaps. Seal cracks and crevices where pests can enter your home.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <div className="w-14 h-14 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-lg flex items-center justify-center mb-4"><Droplets className="w-7 h-7 text-white" /></div>
              <h3 className="text-xl mb-3">Mosquitoes</h3>
              <p className="text-gray-600 mb-2">Eliminate Standing Water</p>
              <p className="text-sm text-gray-500">Empty flower pots, birdbaths, and gutters regularly. Mosquitoes breed in standing water.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <div className="w-14 h-14 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-lg flex items-center justify-center mb-4"><Home className="w-7 h-7 text-white" /></div>
              <h3 className="text-xl mb-3">Kitchen Pests</h3>
              <p className="text-gray-600 mb-2">Store Food Properly</p>
              <p className="text-sm text-gray-500">Keep food in sealed containers, clean up spills immediately, and take out trash regularly.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="why-us" className="py-20 bg-white" aria-label="Why Choose Selke Pest Control">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">We're not just pest control experts – we're your neighbors committed to protecting Charlotte Metro homes</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-cyan-100 rounded-full flex items-center justify-center mx-auto mb-6"><Shield className="w-7 h-7 text-cyan-600" /></div>
              <h3 className="text-xl mb-3">100% Guarantee</h3>
              <p className="text-gray-600">If pests return between treatments, we return at no extra cost. Your complete satisfaction is our priority.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-cyan-100 rounded-full flex items-center justify-center mx-auto mb-6"><Award className="w-7 h-7 text-cyan-600" /></div>
              <h3 className="text-xl mb-3">15+ Years Experience</h3>
              <p className="text-gray-600">Backed by over 15 years of pest control expertise serving North Carolina homes and families.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-cyan-100 rounded-full flex items-center justify-center mx-auto mb-6"><Home className="w-7 h-7 text-cyan-600" /></div>
              <h3 className="text-xl mb-3">Pet & Family Safe</h3>
              <p className="text-gray-600">EPA-approved products that are tough on pests but safe for your loved ones and pets.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-cyan-100 rounded-full flex items-center justify-center mx-auto mb-6"><Users className="w-7 h-7 text-cyan-600" /></div>
              <h3 className="text-xl mb-3">Personalized Service</h3>
              <p className="text-gray-600">You'll work directly with our local team, not a call center.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-cyan-100 rounded-full flex items-center justify-center mx-auto mb-6"><Clock className="w-7 h-7 text-cyan-600" /></div>
              <h3 className="text-xl mb-3">Fast Response</h3>
              <p className="text-gray-600">Most quotes scheduled within 2-3 days. Same-week service available for urgent situations.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50" aria-label="Customer Reviews" itemScope itemType="https://schema.org/LocalBusiness">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">Trusted by Charlotte Metro families</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              { name: "Sarah M.", location: "Mooresville", text: "Finally found a pest control company I can trust! The technician was professional, thorough, and explained everything. No more ants in my kitchen!", rating: 5 },
              { name: "Mike R.", location: "Huntersville", text: "We bundle the mosquito and general pest service and it's been a game changer. We can actually enjoy our backyard again. Highly recommend!", rating: 5 },
              { name: "Jennifer L.", location: "Cornelius", text: "Best decision we made for our home. The Selke team is responsive, professional, and their treatments actually work. Worth every penny.", rating: 5 },
              { name: "David K.", location: "Charlotte", text: "I was skeptical at first, but after one treatment the difference was incredible. No more spiders, roaches gone, and great customer service.", rating: 5 },
              { name: "Amanda T.", location: "Davidson", text: "As a pet owner, I was worried about chemicals. Selke uses safe products and my dogs are fine. Plus, no more fleas! Thank you!", rating: 5 },
              { name: "Robert S.", location: "Lake Norman", text: "The mosquito control is amazing. We had our first outdoor party in years without being eaten alive. The team is fantastic!", rating: 5 },
              { name: "Lisa P.", location: "Matthews", text: "Family-owned and it shows. They treat you like a neighbor, not a number. Quick response, fair pricing, and excellent results.", rating: 5 }
            ].map((review, index) => (
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-wrap justify-center gap-3">
              {['Mooresville', 'Charlotte', 'Cornelius', 'Huntersville', 'Davidson', 'Troutman', 'Denver', 'Weddington', 'Waxhaw', 'Matthews', 'Indian Trail', 'Lake Norman'].map((city) => (
            ...
            <div className="text-center mt-8">
              <p className="text-gray-600">Don't see your city? <a href="tel:704-728-0204" className="text-cyan-600 hover:text-cyan-700 font-semibold">Call us at 704-728-0204</a></p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="tips" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">Expert advice to help you understand and prevent pest problems</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogData.map((blog) => (
              <BlogArticle key={blog.id} icon={blog.icon} title={blog.title} excerpt={blog.excerpt} onClick={() => setActiveBlog(blog.id)} />
            ))}
          </div>
        </div>
      </section>
      ...
      <section id="faq" className="py-20 bg-white" aria-label="Frequently Asked Questions">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { question: "What areas do you service?", answer: "We proudly serve the entire Charlotte Metro area including Mooresville, Charlotte, Cornelius, Huntersville, Davidson, Troutman, Denver, Weddington, Waxhaw, Matthews, Indian Trail, and the Lake Norman region. If you don't see your city listed, give us a call at 704-728-0204 to check if we cover your area." },
              { question: "Are your treatments safe for kids and pets?", answer: "Absolutely! We use EPA-approved products that are tough on pests but safe for your family and pets. Our treatments are designed with your loved ones' safety as our top priority. We'll provide specific instructions if any temporary precautions are needed, but generally, treated areas are safe once dry." },
              { question: "How fast can you come out?", answer: "Most quotes are scheduled within 2-3 days of your initial contact. For urgent situations, we offer same-week service and can often accommodate same-day appointments depending on availability. We understand pest problems can't wait, so we work hard to respond quickly." },
              { question: "What if pests come back between scheduled visits?", answer: "That's covered by our Selke Guarantee! If pests return between your scheduled treatments, we'll come back and retreat at no additional charge. Your complete satisfaction is our priority, and we stand behind our work 100%." },
              { question: "What are your business hours?", answer: "We're available Monday through Saturday, 8:00 AM to 8:00 PM Eastern Standard Time. This gives you flexibility to schedule service at a time that works best for your schedule." },
              { question: "Do you offer bundled services?", answer: "Yes! In fact, 91% of our customers bundle mosquito control with general pest control because it saves money and provides comprehensive protection. Bundling services is more convenient (one visit for multiple treatments) and gives you better value than purchasing services separately." }
            ].map((faq, index) => (
